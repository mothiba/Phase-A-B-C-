...
$tbl =mysql_query("SELECT Product_qty FROM $table WHERE Product_id='".$prod_id."'")or die(mysql_error()); 
$qty=  mysql_fetch_array($tbl);
//echo  $updat[0] .'add<br/>';
//echo $qty[0].' remaining<br/>';
  $data= ($qty[0]+$updat[0]);
$str = mysql_query( "UPDATE $table SET Product_qty='".$data."'WHERE Product_id='".$prod_id."'" )or die(mysql_error());
