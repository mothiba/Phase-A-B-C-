...
function addtocart(txtdiv,txtprodid,txtqty,txtcustid)
{
	...
	/*var id2 = document.getElementById(txtname); 
	id.innerHTML = txtname;*/
...
$strquery = "select Product_id,Product_Name,Product_price,Discount  from $table  where Product_Category='Shoes'";
